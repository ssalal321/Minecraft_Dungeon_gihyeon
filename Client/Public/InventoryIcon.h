...
public:
    typedef struct INVENTORY_ICON_DESC : public CUIObject::UIOBJECT_DESC
    {
        ...
        INVENTORY_ICON_DESC(const wstring& GameObjectTag, UI_STATE uiState,
            ...
            const wstring& texPrototypeTag, ITEM_TYPE itemType, _float speedPerSec = 0.f, _float rotationPerSec = 0.f)
            : UIOBJECT_DESC(GameObjectTag, uiState, x, y, z, sizeX, sizeY, texPrototypeTag,
                speedPerSec, rotationPerSec), eItemType(itemType)
           { }
...
public:
    INVENTORY_ICON_DESC*    Get_Icon_Desc() const { return m_pDesc; }
