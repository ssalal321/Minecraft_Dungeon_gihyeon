...
BEGIN(Client)
class CBabyZombie_Novelty final: public CState_BabyZombie
{
private:
    CBabyZombie_Novelty(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CBabyZombie_Novelty() override = default;
