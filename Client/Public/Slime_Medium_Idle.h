...
class CSlime_Medium_Idle final: public CState_Slime_Medium
{
private:
	CSlime_Medium_Idle(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CSlime_Medium_Idle() override = default;
