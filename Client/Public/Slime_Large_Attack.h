...
class CSlime_Large_Attack final: public CState_Slime_Large
{
private:
    CSlime_Large_Attack(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CSlime_Large_Attack() override = default;
