...
private:
	...
	CBabyZombie(const CBabyZombie& Prototype);
	~CBabyZombie() override = default;
...
private:
	_uint			m_iState = { static_cast<_uint>(BABYZOMBIE_STATE::STATE_END) };

	static _int		m_iBabyZombieID;
...
public:
	static CBabyZombie* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
