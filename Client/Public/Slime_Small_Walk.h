...
class CSlime_Small_Walk final: public CState_Slime_Small
{
private:
    CSlime_Small_Walk(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CSlime_Small_Walk() override = default;
