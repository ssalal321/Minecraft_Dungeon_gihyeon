...
class CPlayer_GetHit final: public CState_Player
{
private:
    CPlayer_GetHit(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEPLAYER_DESC* pDesc);
	~CPlayer_GetHit() override = default;
