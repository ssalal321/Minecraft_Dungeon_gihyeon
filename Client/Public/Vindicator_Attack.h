...
class CVindicator_Attack final: public CState_Vindicator
{
private:
    CVindicator_Attack(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CVindicator_Attack() override = default;
...
private:
    CCollider*  m_pAxeCollider = { nullptr };
