...
BEGIN(Client)
	class CMonster;
	class CCauldronBoss_Trigger : public CGameObject
{
public:
...
private:
	CCauldronBoss_Trigger(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CCauldronBoss_Trigger(const CCauldronBoss_Trigger& Prototype);
	~CCauldronBoss_Trigger() override = default;
...
public:
	static CCauldronBoss_Trigger*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg);
