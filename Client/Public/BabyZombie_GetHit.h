...
class CBabyZombie_GetHit final: public CState_BabyZombie
{
private:
    CBabyZombie_GetHit(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CBabyZombie_GetHit() override = default;
