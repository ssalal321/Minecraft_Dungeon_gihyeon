...
{
public:
	/*struct SLIME_MEDIUM_DESC : public GAMEOBJECT_DESC
	{
		_int     uiCurrentHP;
		_int     uiMaxHP;
		...
		SLIME_MEDIUM_DESC(const _tchar* GameObjectTag, _int currentHP, _int maxHP, _int attackPoint,
		...
		~SLIME_MEDIUM_DESC() override = default;
	};*/
