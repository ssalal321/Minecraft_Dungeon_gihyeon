...
class CBabyZombie_Idle final: public CState_BabyZombie
{
private:
    CBabyZombie_Idle(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CBabyZombie_Idle() override = default;
