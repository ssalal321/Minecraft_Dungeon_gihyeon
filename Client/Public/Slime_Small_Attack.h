...
class CSlime_Small_Attack final: public CState_Slime_Small
{
private:
    CSlime_Small_Attack(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc);
	~CSlime_Small_Attack() override = default;
