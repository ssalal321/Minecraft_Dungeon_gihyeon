...
{
	/* Com_Texture */
	if (nullptr == Add_Component(m_pDesc->iLayerLevelIndex, m_pDesc->strTexPrototypeTag,
		TEXT("Com_Texture"), reinterpret_cast<CComponent**>(& m_pTextureCom)))
		return E_FAIL;

	/* Com_Shader */
	if (nullptr == Add_Component(m_pDesc->iPrototypeLevelIndex, TEXT("Prototype_Component_Shader_VtxPosTex"),
		TEXT("Com_Shader"), reinterpret_cast<CComponent**>(&m_pShaderCom)))
		return E_FAIL;
	  
	/* Com_VIBuffer */
	if (nullptr == Add_Component(m_pDesc->iPrototypeLevelIndex, TEXT("Prototype_Component_VIBuffer_Rect"),
