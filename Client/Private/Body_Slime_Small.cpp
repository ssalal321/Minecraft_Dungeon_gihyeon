...
CBody_Slime_Small::CBody_Slime_Small(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CPartObject(pDevice, pContext)
{

}

CBody_Slime_Small::CBody_Slime_Small(const CBody_Slime_Small& Prototype)
	: CPartObject(Prototype)
{

}

HRESULT CBody_Slime_Small::Initialize_Prototype()
{
...
HRESULT CBody_Slime_Small::Initialize(void* pArg)
{
	BODY_SLIME_SMALL_DESC* pDesc = static_cast<BODY_SLIME_SMALL_DESC*>(pArg);
...
void CBody_Slime_Small::Priority_Update(_float fTimeDelta)
{
}

void CBody_Slime_Small::Update(_float fTimeDelta)
{
}

void CBody_Slime_Small::Late_Update(_float fTimeDelta)
{
...
HRESULT CBody_Slime_Small::Render()
{
...
void CBody_Slime_Small::Collided_With(CCollider* pOther, CCollider::COLLISION_STATE eCollisionState)
{
	dynamic_cast<CSlime_Small*>(m_pContainerObject)->Collided_With(pOther, eCollisionState);
}

HRESULT CBody_Slime_Small::Ready_Components()
{
	/* Com_Shader */
	...
	if (nullptr == Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Slime_Small"),
...
HRESULT CBody_Slime_Small::Bind_ShaderResources()
{
...
CBody_Slime_Small* CBody_Slime_Small::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CBody_Slime_Small* pGameInstance = new CBody_Slime_Small(pDevice, pContext);

	if (FAILED(pGameInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CBody_Slime_Small");
...
CGameObject* CBody_Slime_Small::Clone(void* pArg)
{
	CBody_Slime_Small* pGameInstance = new CBody_Slime_Small(*this);

	if (FAILED(pGameInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CBody_Slime_Small");
		Safe_Release(pGameInstance);
	}
