...
void CInventoryData::Equip_From_StoreSlot(const DoubleClicked_From_StoreSlot& event)  // ∏Ó π¯¬∞ StoreSlotø°º≠ æ∆¿Ã≈€ ∞°¡Æø√ ∞Õ¿Œ∞°?
{
	...
	case ITEM_TYPE::RANGED:
	{
		...
		if (nullptr != pGearItem)  // ∫Û ΩΩ∑‘¿Ã æ¯¿∏∏È
		{
