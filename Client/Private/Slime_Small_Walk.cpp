...
CSlime_Small_Walk::CSlime_Small_Walk(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc)
	: CState_Slime_Small(pActor, pGameObjectDesc, pDesc)
{
}

HRESULT CSlime_Small_Walk::Init_State()
{
	__super::Init_State();
...
void CSlime_Small_Walk::State_Enter()
{
    m_bLostPlayer = false;

    m_pTransformCom->Jump_Start(2.f);
	m_pActorModelCom->Set_Animation(static_cast<_uint>(SLIME_SMALL_STATE::IDLE), true, 0.7f);
}

void CSlime_Small_Walk::State_Priority_Update(_float fTimeDelta)
{
	__super::State_Priority_Update(fTimeDelta);
}

void CSlime_Small_Walk::State_Update(_float fTimeDelta)
{
    ...
    {
        m_pTransformCom->Jump_Start(2.f); // 또는 원하는 점프 초기 속도
    }
...
void CSlime_Small_Walk::State_Late_Update(_float fTimeDelta)
{
	__super::State_Late_Update(fTimeDelta);
}

void CSlime_Small_Walk::State_Exit()
{
}

void CSlime_Small_Walk::Collision_Enter(CCollider* pOther)
{
...
void CSlime_Small_Walk::Collision_Stay(CCollider* pOther)
{
	__super::Collision_Stay(pOther);
}

void CSlime_Small_Walk::Collision_Exit(CCollider* pOther)
{
	__super::Collision_Exit(pOther);
}

void CSlime_Small_Walk::Direction_Setting()
{
...
CState_Monster* CSlime_Small_Walk::Create(CGameObject* pActor, CGameObject::GAMEOBJECT_DESC* pGameObjectDesc, STATEMONSTER_DESC* pDesc)
{
	CSlime_Small_Walk* pGameInstance = new CSlime_Small_Walk(pActor, pGameObjectDesc, pDesc);

	if (FAILED(pGameInstance->Init_State()))
	{
		MSG_BOX("Failed to Create : CSlime_Small_Walk");
